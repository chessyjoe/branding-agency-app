...
export default function BusinessCardPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/generate-business-card", {
        method: "POST",
        body: formData,
      })
      ...
      if (!response.ok) {
        throw new Error(data.error || "Failed to generate business card")
      }
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const filename = `business-card-${timestamp}.png`
    ...
    try {
      const response = await fetch("/api/save-generated-image", {
        ...
        body: JSON.stringify({
          ...
          aspectRatio: "16:10",
          isTemplate: true,
          tags: ["business-card", "generated"],
        }),
      })

      if (response.ok) {
        alert("Business card saved as template!")
      } else {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Create professional business cards with AI-powered design. Perfect for networking and brand
              representation.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Describe the business card you want to create</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    <Label htmlFor="prompt">What kind of business card do you want?</Label>
                    <Textarea
                      id="prompt"
                      placeholder="e.g., Professional business card for a lawyer, elegant design with gold accents, clean typography, contact information layout"
                      value={prompt}
              ...
              <Collapsible open={isEventDetailsOpen} onOpenChange={setIsEventDetailsOpen}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Add event information to enhance your business card design</CardDescription>
                  </CardHeader>
                  <CollapsibleContent>
                ...
                <Card>
                  <CollapsibleTrigger asChild>
                    <CardHeader className="cursor-pointer hover:bg-gray-50 transition-colors">
                      ...
                      <CardDescription>Choose colors for your business card</CardDescription>
                    </CardHeader>
                  </CollapsibleTrigger>
                  <CollapsibleContent>
                    <CardContent>
            ...
            <div className="space-y-6">
              <Card className="min-h-[600px]">
                <CardHeader>
                  ...
                  <CardDescription>Your AI-generated business card will appear here</CardDescription>
                </CardHeader>
                <CardContent className="flex flex-col items-center justify-center min-h-[500px]">
                  ...
                  {isGenerating && (
                    <div className="text-center p-8">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-2">Creating Your Business Card</h3>
                  ...
                  {!result && !isGenerating && !error && (
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-600">
                        Enter a description and click generate to create your business card
                      </p>
                    </div>
                  )}
                </CardContent>
