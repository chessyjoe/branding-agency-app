  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-semibold tracking-tight text-gray-900">Create an account</h1>
        <p className="text-lg text-gray-600">Sign up to start creating with BrandCraft AI</p>
      </div>
